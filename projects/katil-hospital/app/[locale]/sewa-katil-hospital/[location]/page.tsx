...
export async function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  ...
  if (!loc) return { title: 'Hospital Bed Rental — KatilCare' }
  ...
  return {
    ...
    alternates: {
      canonical: `/${locale}/sewa-katil-hospital/${location}`,
      languages: {
        en: `/en/sewa-katil-hospital/${location}`,
        ms: `/ms/sewa-katil-hospital/${location}`,
        zh: `/zh/sewa-katil-hospital/${location}`,
        'x-default': `/en/sewa-katil-hospital/${location}`,
      },
    },
    openGraph: {
      title,
      description,
      url: `${siteConfig.baseUrl}/${locale}/sewa-katil-hospital/${location}`,
