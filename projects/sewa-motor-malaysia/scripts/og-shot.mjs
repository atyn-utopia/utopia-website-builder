...
// This site's hero section is .home-hero, not .hero.
...
const HIDE = [
  ...
  // This hero's own foot elements are prefixed .home-hero-*, so the canonical
  // .hero-stats never matched. The stat row and the USP panel below it both
  // sit inside the hero and were being sliced mid-text by the 630 crop.
  '.home-hero-stats', '.usp-panel',
];
// ─────────────────────────────────────────────────────────────────────────
