      ...
      <main>
          ...
          <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-0 md:pt-24 md:pb-0">
            <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-end">
              ...
              <div className="pb-12 md:pb-24">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white mb-8" style={{ letterSpacing: '-0.02em', lineHeight: '1.45' }}>
        ...
        <section className="py-28 md:py-32 px-6" style={{ background: 'var(--brand-dark)' }}>
          <div className="max-w-3xl mx-auto text-center">
            <FadeSection>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-7" style={{ lineHeight: '1.4' }}>
                {t('cta.heading', { city: displayName })}
              </h2>
              <h5 className="text-sm md:text-base font-normal mb-12" style={{ color: 'rgba(255,255,255,0.7)', lineHeight: '2' }}>
