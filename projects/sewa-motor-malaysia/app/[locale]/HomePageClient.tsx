      ...
      <header className="sticky top-0 z-50" style={{ background: 'var(--brand-dark)', boxShadow: '0 2px 12px rgba(22,33,62,0.2)' }}>
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <LanguageSwitcher />
            <WhatsAppClickTracker phoneNumber={phoneNumber} href={WA_LINK} className="wa-btn inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold text-white" style={{ background: 'var(--wa-green)' }}>
      ...
      <main>
        ...
        <section className="py-10 px-6" style={{ background: 'linear-gradient(135deg, var(--brand-primary), var(--brand-coral))' }}>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <WhatsAppClickTracker phoneNumber={phoneNumber} href={WA_LINK} className="wa-btn inline-flex items-center gap-2.5 px-6 py-3 rounded-xl text-sm font-bold text-white" style={{ background: 'var(--wa-green)' }}>
      ...
      <footer className="py-10 px-6" style={{ background: '#0F1A2E' }}>
        <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <WhatsAppClickTracker phoneNumber={phoneNumber} href={WA_LINK} className="inline-flex items-center gap-2 text-xs font-semibold hover:opacity-80" style={{ color: 'var(--wa-green)' }}><WAIcon />WhatsApp Us</WhatsAppClickTracker>
          </div>
        </div>
