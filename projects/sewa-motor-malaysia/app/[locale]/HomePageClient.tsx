                  ...
                  <FadeSection key={pk.id} delay={i * 60} full>
                    <div className="product-card h-full flex flex-col">
                      ...
                      <div className="p-5 flex flex-col flex-1">
                        ...
                        <a href={waRedirect(locale, pk.model)} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg text-sm font-semibold text-white hover:opacity-90 w-full" style={{ background: 'var(--brand-primary)' }}>
