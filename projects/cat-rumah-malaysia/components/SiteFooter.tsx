...
//
// Palette stays Cat Rumah Express's own cream + blue — the CI is a structural
    ...
    <footer className="site-footer">
      <div className="container">
        <div className="footer-top">
          ...
          <img src="/images/brand/logo-light.png" alt={navT('logoAlt')} className="footer-logo" />
      ...
      <style>{`
        ...
        .footer-logo { width: 132px; height: auto; object-fit: contain; }
        .footer-nav { display: flex; flex-wrap: wrap; gap: 12px 26px; }
        .footer-nav a {
          color: var(--brand-ink); font-weight: 600; font-size: 14.5px;
        ...
        .footer-copy { margin: 0; font-size: 12.5px; font-weight: 400; color: var(--muted); }
        .utopia-credit { color: var(--muted); }
