...
export default async function HomePage({
  ...
  const calcRates = {
    ec200: { daily: Number(productCards[0].rentalPrice), monthly: Number(fallback5L.monthly) },
    ec400: { daily: Number(productCards[1].rentalPrice), monthly: Number(fallback10L.monthly) },
  };
      ...
      <section className="hero">
        ...
        <div className="container hero-grid">
          <div className="hero-text">
            ...
            <img src="/brand/oxihome-dark.png" alt={tNav('logoAlt')} width={600} height={441} className="hero-logo" />
