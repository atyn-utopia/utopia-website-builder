  ...
  return (
    <div className="calc-panel">
      ...
      <style jsx>{`
        ...
        .calc-glow { position: absolute; inset: 0; background: radial-gradient(40% 60% at 20% 20%, rgba(14, 123, 214,0.20) 0%, rgba(14, 123, 214,0) 70%); pointer-events: none; }
        ...
        .calc-chip { flex: 1; min-width: 0; padding: 12px 14px; border-radius: 12px; background: transparent; border: 1.5px solid var(--line-on-dark-strong); color: rgba(255,255,255,0.85); font-weight: 600; font-size: 14px; cursor: pointer; transition: background-color var(--dur) var(--ease-out), border-color var(--dur) var(--ease-out), color var(--dur) var(--ease-out); }
        ...
        .calc-from { font-family: var(--font-display); font-weight: 600; font-size: clamp(0.95rem, 1.4vw, 1.125rem); letter-spacing: 0.02em; color: rgba(255,255,255,0.55); text-transform: uppercase; align-self: center; margin-right: 2px; }
