  ...
  return (
    <div className="redir-overlay">
      <div className="redir-inner">
        ...
        <img src="/brand/tankpro-dark.png" alt="TANKPRO Malaysia" className="redir-logo" />
      ...
      <style>{`
        ...
        .redir-heading { font-size: 1.3rem; font-weight: 700; letter-spacing: -0.02em; color: #0A2540; margin: 0 0 0.5rem; line-height: 1.2; }
