...
const PORT = 3015;
// The hero here is a class-less <section> styled inline inside HomePageClient,
// so the template's default `section.hero` selector matches nothing. It does
// uniquely contain .kh-hero-copy, so key off that instead.
const HERO = 'section:has(.kh-hero-copy)';
const HIDE = [
