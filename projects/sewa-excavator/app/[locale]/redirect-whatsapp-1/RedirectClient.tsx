  ...
  return (
    <div className="redir-overlay">
      <div className="redir-inner">
        ...
        <img src="/brand/abang-excavator-light.png" alt="Abang Excavator" className="redir-logo" />
      ...
      <style>{`
        ...
        .redir-logo { width: auto; height: 76px; margin: 0 auto 1.5rem; display: block; }
        ...
        .redir-heading { font-size: 1.3rem; font-weight: 700; letter-spacing: -0.02em; color: #0F0F0F; margin: 0 0 0.5rem; line-height: 1.2; }
