  ...
  return (
    <>
      ...
      <style>{`
        ...
        .breadcrumb a { color: var(--brand-orange-bright); font-weight: 500; }
        .breadcrumb span[aria-hidden="true"] { color: rgba(255,255,255,0.3); }
        .breadcrumb [aria-current="page"] { color: #fff; font-weight: 500; }
        .blog-hero h1 { font-size: clamp(2rem, 4.5vw, 3.25rem); font-weight: 700; color: #fff; margin: 0; letter-spacing: -0.025em; }
        ...
        .blog-card-date { font-family: var(--font-mono-stack); font-weight: 500; font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--ink-muted); margin: 0; }
