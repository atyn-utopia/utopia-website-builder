  ...
  return (
    <>
      ...
      <style>{`
        ...
        .post-header .breadcrumb a { color: var(--brand-orange-deep); font-weight: 500; }
        .post-header .breadcrumb [aria-current="page"] { color: var(--brand-charcoal); font-weight: 500; }
        .post-header h1 { font-size: clamp(2rem, 4vw, 2.875rem); font-weight: 700; color: var(--brand-charcoal); letter-spacing: -0.025em; line-height: 1.1; margin: 0 0 12px; max-width: 800px; }
        .post-excerpt { font-size: clamp(1rem, 1.4vw, 1.1875rem); color: var(--ink-muted); line-height: 1.6; max-width: 740px; margin: 0; }
        .post-meta { display: inline-flex; flex-wrap: wrap; gap: 10px; font-family: var(--font-mono-stack); font-weight: 500; font-size: 12px; letter-spacing: 0.08em; text-transform: uppercase; color: var(--ink-faint); margin: 18px 0 0; }
        ...
        .post-sidebar a { color: var(--ink); font-weight: 500; font-size: 14px; line-height: 1.4; }
